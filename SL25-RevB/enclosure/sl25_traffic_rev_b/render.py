...
def overview():
    ...
    text(draw, (66, 108), "Rev B · Ø24 mm 扩散膜灯窗 · 30 × 30 × 30 mm", 25, MUTED)
...
def drawing():
    ...
    arrow(draw, (760, 820), (1240, 820), "30（含遮光帽）", (904, 832))
...
if __name__ == "__main__":
    ...
    text(ImageDraw.Draw(hood_sheet), (60, 828), "顶部 5 mm · 两侧中部约 2 mm · 安装环 0.8 mm", 26, MUTED)
